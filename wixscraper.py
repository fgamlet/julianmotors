...
async def main():
    ...
    # Use pyppeteer's bundled Chromium in headless mode
    browser = await launch(headless=True, defaultViewport=None, args=['--window-size=1920,1080', '--no-sandbox', '--disable-setuid-sandbox'])
